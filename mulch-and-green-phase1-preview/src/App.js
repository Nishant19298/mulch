...
import Softscape from "@/pages/Softscape";
      ...
      <BrowserRouter>
        ...
        <main className="pt-20">
          <Routes>
            ...
            <Route path="/landscaping/hardscape" element={<Hardscape />} />
            <Route path="/landscaping/softscape" element={<Softscape />} />
            <Route path="/landscaping/creative-plant-beds-garden-design" element={<GardenDesign />} />
