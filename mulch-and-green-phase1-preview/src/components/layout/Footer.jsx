        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-[14px]">
              ...
              <li><Link to="/landscaping" className="hover:text-grass transition-colors" data-testid="footer-landscaping">Landscaping</Link></li>
              <li><Link to="/landscaping/hardscape" className="hover:text-grass transition-colors pl-3" data-testid="footer-hardscape">— Hardscape</Link></li>
              <li><Link to="/landscaping/softscape" className="hover:text-grass transition-colors pl-3" data-testid="footer-softscape">— Softscape</Link></li>
              <li><Link to="/landscaping/creative-plant-beds-garden-design" className="hover:text-grass transition-colors" data-testid="footer-garden-design">Garden Design</Link></li>
